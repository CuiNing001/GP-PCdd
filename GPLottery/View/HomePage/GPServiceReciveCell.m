...
@interface GPServiceReciveCell()
@end

@implementation GPServiceReciveCell
...
#pragma mark - 根据文本自适应cell高度
- (void)cellHeightWithModel:(JMSGMessage *)model{
    
    [self layoutIfNeeded];
    
    if (model.contentType == kJMSGContentTypeImage) {
        
        JMSGImageContent *imageContent = (JMSGImageContent *)model.content;
